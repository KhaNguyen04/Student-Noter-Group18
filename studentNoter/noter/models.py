...
#     userId=models.ForeignKey(User,related_name="user_color_set", on_delete=models.CASCADE,null=True)
...
class Category(models.Model):
    ...
    # color=models.ForeignKey(Color,related_name="color_category_set",on_delete=models.CASCADE,null=True)
    def __str__(self):
        return self.name
